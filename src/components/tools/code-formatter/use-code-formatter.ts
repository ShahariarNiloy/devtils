...
const SAMPLES: Record<LanguageId, string> = {
  ...
  json: `{"name":"devtils","version":"1.0.0","dependencies":{"react":"^19.0.0","next":"^16.0.0"},"scripts":{"dev":"next dev","build":"next build"}}`,
  json5: `{name:'devtils',version:'1.0.0',// dependencies\ndeps:{react:"^19.0.0",next:"^16.0.0",}}`,
