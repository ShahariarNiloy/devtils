...
import { SingleMode } from "./modes/single-mode";
import { CompareMode } from "./modes/compare-mode";
import { ArithmeticMode } from "./modes/arithmetic-mode";
import { BatchMode } from "./modes/batch-mode";
