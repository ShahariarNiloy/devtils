      ...
      >
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-1.5 justify-end">
            {!available && (
              <span className="rounded-md px-2 h-5 inline-flex items-center text-sm font-semibold uppercase tracking-widest text-text-faint bg-surface-soft">
                Soon
              </span>
            )}
            {tool.wasm && (
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <p
            className={cn("leading-normal text-text-faint", isFeature ? "text-sm" : "text-sm")}
          >
            {tool.description}
          </p>
        </div>
