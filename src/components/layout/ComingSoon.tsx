      ...
      <section className="border-b border-border bg-bg">
        <div className="mx-auto max-w-7xl px-5 sm:px-8 pt-7 pb-9 sm:pt-9">
          ...
          >
            ...
            <div className="mt-5 flex flex-wrap items-center gap-2 text-2xs font-semibold uppercase tracking-eyebrow text-text-faint">
            ...
            <p
              className="mt-6 max-w-xl text-sm-plus text-text-muted"
            ...
            <div className="mt-7 flex flex-wrap items-center gap-3">
              <Link
                href="/tools"
                className="inline-flex items-center gap-2 rounded-button px-4 h-btn-md text-sm-plus font-semibold transition-transform hover:-translate-y-px bg-brand text-text-on-sage"
                style={{
              ...
              <Link
                href={`/tools?cat=${encodeURIComponent(tool.category)}`}
                className="inline-flex items-center gap-2 rounded-button border border-border bg-transparent px-4 h-btn-md text-sm-plus font-semibold text-text transition-colors hover:border-border-strong hover:bg-surface"
              >
