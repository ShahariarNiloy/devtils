/**
 * The tool data registry. 168 entries, one per planned tool route at
 * /tools/[slug]. Sorted alphabetically by display name. The flat-data /
 * derived-state / helper-functions trio lives in separate sibling files
 * (queries.ts, category-meta.ts) so churn in any one of them does not
 * force a re-review of the others.
 */
...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    name: 'Code formatter',
    description:
      'Format JS, TS, JSON, CSS, HTML, Markdown, YAML, and GraphQL with Prettier — runs in your browser.',
    category: 'Code',
    tier: 'free',
    icon: 'code-2',
    tags: [
  ...
  },
  {
    ...
    description: 'Convert px ↔ rem, em, %, pt, pc, in, cm, mm, vw, vh — and build fluid clamp() expressions with live preview.',
    category: 'Design',
    tier: 'free',
    icon: 'ruler',
    tags: ['css', 'rem', 'px', 'unit', 'clamp', 'fluid', 'em', 'pt', 'vw'],
    isNew: true,
    showcase: true,
  },
  {
    ...
    description: 'Convert px to rem instantly. Configurable root font-size, 10px shortcut supported, runs in your browser.',
    category: 'Design',
    tier: 'free',
    icon: 'ruler',
    tags: ['px to rem', 'pixels to rem', 'rem', 'converter', 'css'],
    isNew: true,
  },
  {
    slug: 'rem-to-px-converter',
    name: 'Rem to px converter',
    description: 'Convert rem to pixels instantly with any root font-size. Reverse a stylesheet or audit a design token in one click.',
    category: 'Design',
    tier: 'free',
    icon: 'ruler',
    tags: ['rem to px', 'rem to pixels', 'px', 'converter', 'css'],
    isNew: true,
  },
  {
    slug: 'px-to-em-converter',
    name: 'Px to em converter',
    description: 'Convert pixels to em with a configurable parent font-size. Matches the way em is used in 99% of real CSS.',
    category: 'Design',
    tier: 'free',
    icon: 'ruler',
    tags: ['px to em', 'pixels to em', 'em', 'converter', 'css'],
  },
  {
    slug: 'em-to-px-converter',
    name: 'Em to px converter',
    description: 'Convert em to pixels instantly. Useful for auditing inherited typography scales and translating tokens to absolute values.',
    category: 'Design',
    tier: 'free',
    icon: 'ruler',
    tags: ['em to px', 'em to pixels', 'px', 'converter', 'css'],
  },
  {
    slug: 'px-to-pt-converter',
    name: 'Px to pt converter',
    description: 'Convert CSS pixels to typography points. 16px = 12pt exactly, per the CSS spec — independent of display DPI.',
    category: 'Design',
    tier: 'free',
    icon: 'ruler',
    tags: ['px to pt', 'pixels to points', 'point', 'typography', 'converter'],
  },
  {
    slug: 'pt-to-px-converter',
    name: 'Pt to px converter',
    description: 'Convert points to CSS pixels. 12pt = 16px, 9pt = 12px — exact CSS-spec conversion regardless of display DPI.',
    category: 'Design',
    tier: 'free',
    icon: 'ruler',
    tags: ['pt to px', 'points to pixels', 'pixel', 'typography', 'converter'],
  },
  {
    slug: 'csv-to-json',
